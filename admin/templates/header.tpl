...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../dojo/dijit/themes/tundra/tundra.css" />{section name=css loop=$allcss}
    <link title="{$allcss[css]}" rel="stylesheet" type="text/css" href="{$allcss[css]}" />{/section}
</head>
