{include file="header.tpl" title="Mainpage"} {include file="menu.tpl"} {include file="messagebox.tpl"} <span> {section name=id loop=$plugins} <a class="button" href="plugin.php?plugin={$plugins[id]->getId()}" title="{$plugins[id]->getDescription()}">{$plugins[id]->getName()}</a> {/section} </span>
...
<div id="rawPlugin">
    ...
    <ul>
        ...
        <li>
            <form action="plugin.php?action=editPluginInstance&pluginId={$instancedPlugin->getId()}" method="post">
                ...
                <br />
                <label for="description">Description</label>                <textarea height="40px" name="instancePluginDescription">{$instancedPlugin->getDescription()}</textarea>
    ...
    <form action="plugin.php" method="get">
        <table>
            ...
            <tr>
                ...
                <input value="{$getPluginEdit['path']}" type="text" disabled  />
                </td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                ...
                <input value="{$getPluginEdit['name']}" type="text" name="name" />
                </td>
            </tr>
