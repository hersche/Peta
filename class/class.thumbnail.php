 ...
 * @version svn:$Id$
 ...
 INFOS unter http://rexdev.de/klassen/image_resize.html
 */
...
class rex_thumbnail
{
  ...
  /**
   * Bild in Rechteck-Fläche einpassen
   *
   * @param $width int Breite der Rechteck-Fläche
   * @param $height int Hoehe der Rechteck-Fläche
   */
