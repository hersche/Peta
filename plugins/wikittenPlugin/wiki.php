...
class Wiki
{
    ...
    {
        $path  = LIBRARY . DIRECTORY_SEPARATOR . $page;
        $parts = explode('/', $page);
        ...
        $mime_type = $finfo->file(realpath(LIBRARY . DIRECTORY_SEPARATOR . $page));
        //$finfo = finfo_open(FILEINFO_MIME,realpath(LIBRARY . DIRECTORY_SEPARATOR . $page));
        //$mime_type = finfo_file($finfo, realpath(LIBRARY . DIRECTORY_SEPARATOR . $page));
    ...
    public function indexAction()
    {
        ...
        //var_dump(LIBRARY . DIRECTORY_SEPARATOR);
        $page = $_GET['page'];
        if(!isset($_GET['page'])){
         $page = "index.md";   
        }
