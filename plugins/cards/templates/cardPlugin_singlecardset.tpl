...
<h1>{$cardsettitle}</h1> &nbsp; <a href="plugin.php?plugin={$pluginId}&action=editcardset&setid={$setid}" class="button edit">Edit questionset</a>
&nbsp;
...
<form
	action="plugin.php?plugin={$pluginId}&amp;action=singlecardset&amp;setid={$setid}&amp;nextquestion={$nextquestion}&amp;random={$random}"
	method="post">
<table>
	<tr>
		<td>{$question}</td>
	...
	<tr>
		...
		<td><a
			href="plugin.php?plugin={$pluginId}&amp;action=editquestion&amp;setid={$setid}&amp;questionid={$questionid}"><img alt="Edit question" src="img/edit.png" /></a><a
			href="plugin.php?plugin={$pluginId}&amp;action=deletequestion&setid={$setid}&questionid={$questionid}"><img "alt="Delete question" src="img/delete.png" /></a></td>
	</tr>
