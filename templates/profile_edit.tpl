...
<form action="profile.php?action=edit&amp;actionEditId={$editCustomField->getId()}" id="editCustomfieldForm" method="POST">
    <table width="90%">
        ...
        <tr>
            ...
            <div class="editor" data-dojo-type="dijit/Editor" id="editCustomfieldEditor" data-dojo-props="{literal}extraPlugins:[],onChange:function(){document.getElementById('editorSend2').value = this.getValue();}"{/literal}>
                <p>
...
<form action="profile.php?action=edit" method="POST">
    <table width="90%">
        <tr>
            ...
            <div class="editor" data-dojo-type="dijit/Editor" id="editor" data-dojo-props="{literal}extraPlugins:[],onChange:function(){document.getElementById('editorSend').value = this.getValue();}"{/literal}> <p></p></div></td>
        </tr>
        <tr>
            <td>
